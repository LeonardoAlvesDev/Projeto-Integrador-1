...
public class ProjetoScript {
	...
	public static void main(String[] args) {
		...
		case "1":
			...
			JOptionPane.showMessageDialog(null, "Se não sabe jogar se fudeu");
		break;
	    ...
	    raca = JOptionPane.showInputDialog("Digite qual opção desejada:  \n 1-Humano: \n 2-Extraterrestre:");
	   	...
	   	JOptionPane.showMessageDialog( null, nick +" era habitante do planeta “-B -B -B” porém\r\n" + 
	   			...
	   			"ele viaja pela galáxia buscando trazer a paz aos planetas que \r\nestão" + 
	   			"em guerra para que os inocentes não acabem pagando pela\r\n" + 
