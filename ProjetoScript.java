             ...
             /*  Path caminho = Paths.get("C:/Users/Gabriel/Desktop/Arquivos Projeto/teste.txt");   
                    ...
                    if (escolha.equalsIgnoreCase("1")) {
                        ...
                        if (naveInimiga[0] <= 0) {
                            ...
                            JOptionPane.showMessageDialog(null,
                                    "Você adquiriu uma arma de mão... uma pistola a laser muito usada em batalhas terrestres\n"
                                    + "Dano da Pistola = " + danoPistola);
                        ...
                        JOptionPane.showMessageDialog(null,
                                ...
                                + "informações sobre eles, você esconde sua nave e está apenas com uma arma (com a qual ainda não \n"
                                + "possui muita habilidade) percebe então que está sendo vigiado enquanto caminha, e uma espécie \n"
                                ...
                                + "porém os ciclopes são extremamente altos e sua força física e vital são incomparáveis",
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Você fica preocupado com que esta batalha tenha causado muito barulho, então rapidamente\n"
                                + "entra na sala mais próxima para não ser notado, e ao se virar dá de cara com uma sala\n"
                                + "cheia de armamento e kits de primeiro socorros... você vê uma mochila, porém ela só tem\n "
                                + "espaço para mais uma arma e 2 kits, você pega esses kits e uma sniper que será muito util" + " ",
                                "Item", JOptionPane.INFORMATION_MESSAGE);
                        
                        JOptionPane.showMessageDialog( null,"A sniper só pode ser usada em ataques de longa distância\n"
                        									+ "e só no primeiro ataque... seu ataque critico, pode até ser um hit kill\n "
                        									+ " seu dano é de "+danoSniper + " ","OBs",JOptionPane.INFORMATION_MESSAGE );
                        ...
                        mochila[3]= "kit de primeiros socorros";
                          ...
                          if(vidaPersonagem[0] <= 80) {
                        	  ...
                        	  escolha =  JOptionPane.showInputDialog("Você deseja verificar se ainda tem kit médico na mochila? \n Digite 'sim' ou 'não");
                         ...
                         do {
                          ...
                          if(itensMochila.equals("Sniper")) {
							...
							case 1:
								...
								break;
							case 2:
								  JOptionPane.showMessageDialog(null, "Dano " +dano+ " você acertou o tiro porém não foi o suficiente para matá-los");
								  vidaSegurancas[0]-=dano;
								  break;
							case 3:
								  JOptionPane.showMessageDialog(null, "Dano " +dano+ " crítico, você matou o primeiro segurança");
								  vidaSegurancas[0]-=dano;
								  break;
                           ...
                           JOptionPane.showMessageDialog(null,"Pontos de vida = " + vidaPersonagem[0] + "\nVida segurança 1 = " +vidaSegurancas[0]
                            ...
                            mochila[1] = "'Vazio'";
                              ...
                              if(vidaSegurancas[0] <=0) {
                            	  ...
                            	  do {
                            	   ...
                            	   if(itensMochila.equals("Pistola")) {
                                      ...
                                      case 1:
                                    	  ...
                                    	  break;
                                      case 2:
                                    	  JOptionPane.showMessageDialog(null, "Você acertou o segurança, porém ele contra-atacou");
                                    	  vidaPersonagem[0]-=10;
                                    	  vidaSegurancas[1]-=10;
                                    	  break;
                                      case 3:
                                      ...
                                      case 4:
                                    	  ...
                                    	  break;
                                      case 5:
                                    	  JOptionPane.showMessageDialog(null, "Dano de " + danoBatalhaSegurancas +", crítico");
                                    	  vidaSegurancas[1]-=danoBatalhaSegurancas;
                                    	  break;
                                      case 6:
                            	  ...
                            	  JOptionPane.showMessageDialog(null, "Escolha sua arma... ainda tem muita batalha pela frente");
                            	   itensMochila = JOptionPane.showInputDialog(null,"Mochila","Escolha", JOptionPane.INFORMATION_MESSAGE, 
                            	             null, mochila, mochila[0]); 
                            	   ...
                            	   if(itensMochila.equals("Pistola")) {
                                        ...
                                        if(vidaSegurancas[0] <= 0) {
                              		   ...
                              		   if(vidaSegurancas[0] == 0){
                              			  JOptionPane.showMessageDialog(null,"Você derrotou um dos seguranças, ainda falta um");
                          ...
                          String ataques[]= {"Escolha...","Metralhadora","Lança míssil"};
                          int danoAtaques[] = {30,200};
                          int vidaEsquadra[] = {1000,1000};
                          vidaNave[0] = 150;
                		  JOptionPane.showMessageDialog(null, "Ao matar os seguranças você chamou muita atenção, logo voltar para nave é a melhor opção que\n"
                		  		                            + " lhe resta, temendo que uma esquadra esteja te esperando do lado de fora você decide armar \n"
                		  		                            + "melhor sua nave com uma metralhadora e um lança míssil que estão guardados, e para sua defesa, \n"
                		  		                            + "um escudo... porém todo esse armamento e o escudo ainda não são garantia de que você irá sobreviver...");
                		
                		 
                		  JOptionPane.showMessageDialog(null,"Você levanta voo e ao sair acontece o que mais temia, uma esquadra de seguranças e o líder\n "
 		                                                   + "deles, Jhon Pane, estão à sua espera...");
 
                          JOptionPane.showMessageDialog(null,"O lança míssil tem dano em área podendo atingir um dano de 600... pode ser utilizado\n"
		                                                   + "apenas uma vez e no começo da batalha e a metralhadora tem um dano de 30" );
                		  

                          JOptionPane.showMessageDialog(null,"Seus pontos de vida = "+vidaNave[0]+
                        		  "\nVida esquadra = " + vidaEsquadra[0]+"\nJohn pane = " + vidaEsquadra[1] );
                          
                          do {
                			  Ataques = JOptionPane.showInputDialog(null,"Ataques","Escolha", JOptionPane.INFORMATION_MESSAGE, 
                   	             null, ataques, ataques[0]); 
                		  }while(Ataques == "Escolha...");
                	 		 
                	 		  if(Ataques == "Lança míssil") {
                	 			  ataques[2] = "'Vazio'";
                              ...
                              int dano = (dado3*danoAtaques[1]);
                                                         
                              switch (dado3) {
                                                       
							case 1:
								  JOptionPane.showMessageDialog(null, "Você acertou poucas naves");
								 vidaEsquadra[0]-=dano;
								  
								break;
							case 2:
								  JOptionPane.showMessageDialog(null, "Dano " +dano+ ", você destruiu quase metade da esquadra");
								  vidaEsquadra[0]-=dano;
								  break;
							case 3:
								  JOptionPane.showMessageDialog(null, "Dano " +dano+ ", crítico, você destruiu mais da metade da esquadra");
								  vidaEsquadra[0]-=dano;
								  break;
							...
							default: System.out.println("erro1");
                              ...
                              JOptionPane.showMessageDialog(null,"Ainda tem muita batalha pela frente, escolha sua arma");
                              do {
                    			  Ataques = JOptionPane.showInputDialog(null,"Ataques","Escolha", JOptionPane.INFORMATION_MESSAGE, 
                       	             null, ataques, ataques[0]); 
                    		  }while(Ataques == "Escolha..." && Ataques == "'Vazio'");
                            ...
                            int danoBatalhaEsquadrao = (dado3*danoAtaques[0]);
                            ...
                            case 1:
                          	 ...
                          	 vidaNave[0]-=10;
                          	  break;
                            case 2:
                          	  JOptionPane.showMessageDialog(null, "Dano não surtiu efeito");
                          	  vidaNave[0]-=10;
                          	  break;
                            case 3:
                          	  JOptionPane.showMessageDialog(null, "Você não conseguiu disparar");
                          	 vidaNave[0]-=20;
                          	  break;
                            case 4:
                          	  JOptionPane.showMessageDialog(null, "Dano de " + danoBatalhaEsquadrao +", forte");
                          	 vidaEsquadra[0]-=danoBatalhaEsquadrao;
                          	  break;
                            case 5:
                          	  JOptionPane.showMessageDialog(null, "Dano de " + danoBatalhaEsquadrao +", crítico");
                          	 vidaEsquadra[0]-=danoBatalhaEsquadrao;
                          	  break;
                            case 6:
                          	  JOptionPane.showMessageDialog(null, "Dano de " + danoBatalhaEsquadrao +", crítico");
                          ...
                          }while( vidaEsquadra[0]>0 && vidaNave[0]>0);
                       	   
                       	   if(vidaEsquadra[0] == 0) {
                       		 JOptionPane.showMessageDialog(null, "Parabéns!! você sozinho conseguiu conter a esquadra\n"
                       		 		+ "agora só resta Jhon Pane");
                       		   
                       	   }
                       	   
                       	   else if(vidaNave[0] == 0) {
                       		   
                       		 JOptionPane.showMessageDialog(null, "Sua nave foi destruida\n Fim de joogo");
                       		 break;
                       	   }
                          ...
                          // batalha final
                	 		 JOptionPane.showMessageDialog(null, "Seu inimigo agora é Jhon pane, famoso por ser o líder dos otaidi e por conquistar nações sozinho\n "
	 								   + "apenas usando sua arma mais mortal, printeasy... seu sistema de defesa aguenta apenas um tiro desta\n "
	 								   + "arma, procure eliminá-lo o quanto antes.");
                	 		 
                	 		 JOptionPane.showMessageDialog(null, "Você poderá contar com mais um tiro da lança míssil ");
                	 		 ataques[2] = "Lança míssil";
                	 	      ...
                	 	      do {
    							...
    							case 1:
    								  JOptionPane.showMessageDialog(null, "Dano fraco");
    								 vidaEsquadra[1]-=dano;
    								  
    								break;
    							case 2:
    								  JOptionPane.showMessageDialog(null, "Dano " +dano+ ", forte");
    								  vidaEsquadra[1]-=dano;
    								  break;
    							case 3:
    								  JOptionPane.showMessageDialog(null, "Dano " +dano+ ", crítico, porém não mortal");
    								  vidaEsquadra[1]-=dano;
    								  break;
							...
							do {  
                                ...
                                case 2:
                              	  ...
                              	  break;
                                case 3:
                              	  JOptionPane.showMessageDialog(null, " A arma printeasy te acertou");
                              	 count++;
                              	  break;
                                case 4:
                              	  JOptionPane.showMessageDialog(null, "Dano de " + danoBatalhaEsquadrao +", forte");
                              	 vidaEsquadra[1]-=danoBatalhaEsquadrao;
                              	  break;
                                case 5:
                              	  JOptionPane.showMessageDialog(null, "Dano de " + danoBatalhaEsquadrao +", crítico");
                              	 vidaEsquadra[1]-=danoBatalhaEsquadrao;
                                ...
                                if(vidaEsquadra[1] < 0) {
                           	   ...
                           	   if(vidaEsquadra[1] == 0) {
                           		 ...
                           		 JOptionPane.showMessageDialog(null, "Printeasy te acertou mais de uma vez e você foi derrotado");
                           		 break;
                ...
                case "3":
                    ...
                    JOptionPane.showMessageDialog(null, "Feito por Gabriel Moraes, Leonardo Alves Almeida e Leonardo Margarida(Maguerditchian) de Araujo");
                    break;
